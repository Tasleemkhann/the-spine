<!DOCTYPE html>
<html lang="en">
  <!-- Mirrored from st.ourhtmldemo.com/new/humanity-html/checkout.php by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 07 May 2024 08:22:14 GMT -->
  <head>
    <meta charset="UTF-8" />
          ...
          <div class="row">
            <div class="col-md-6 col-sm-12 col-xs-12">
              <div class="form billing-info">
                ...
                <form
                  method="post"
                  action="https://st.ourhtmldemo.com/new/humanity-html/checkout.php"
                >
                  <div class="row">
                    <div class="col-md-12">
